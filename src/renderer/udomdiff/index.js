...
const remove = function (_ref) {
	const firstChild = _ref.firstChild,
...
const diffable = function (node, operation) {
 ...
 */
const udomdiff = function (parentNode, a, b, get = diffable, before) {
